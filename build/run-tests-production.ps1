...
dotnet test "$prodTestDir/DNDocs.ProductionTests.csproj" --results-directory "$PSScriptRoot/temp/tests-prod-logs-$date" 
set-content "$prodTestDir/settings.json" -encoding utf8 -value '{ }';